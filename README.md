...
A programming language designed to be approachable without sacrificing competence. PLAIN prioritizes clear thinking over clever syntax, natural readability over terse notation, and honest capability over complex features. PLAIN is the second of 3 teaching languages developed by Fragillidae Software. The others are STEPS (verbose English like entry langauge) and FORGE (statically typed systems prorgamming language with easier beginner entry than C).
